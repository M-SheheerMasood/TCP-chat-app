...
if __name__ == "__main__":
    ...
    total_marks = (total_mi_marks + total_cc_marks + total_pylint_marks + total_comments_marks)/2
    ...
    for file_path in args.file_paths:
        ...
        try:
            ...
            print(f"  Total score: {final_score/2}/{total_marks}\n")
    ...
    if total_files > 0:
        average_score = (total_scores / total_files)/2
